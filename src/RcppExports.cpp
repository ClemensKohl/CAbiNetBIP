...
RcppExport SEXP _CAbiNet_bip_ComputeSNNasym(SEXP SNNSEXP, SEXP pruneSEXP, SEXP modeSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _CAbiNet_bip_calc_overlap(SEXP cc_adjSEXP, SEXP cg_adjSEXP, SEXP thresholdSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _CAbiNet_bip_calc_overlap_deprecated(SEXP cc_adjSEXP, SEXP cg_adjSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_CAbiNet_bip_ComputeSNNasym", (DL_FUNC) &_CAbiNet_bip_ComputeSNNasym, 3},
    {"_CAbiNet_bip_calc_overlap", (DL_FUNC) &_CAbiNet_bip_calc_overlap, 3},
    {"_CAbiNet_bip_calc_overlap_deprecated", (DL_FUNC) &_CAbiNet_bip_calc_overlap_deprecated, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_CAbiNet_bip(DllInfo *dll) {
