...
df <- data.frame(
  row.names = c("CD19", "CD3", "CD4", "CD8", "ACTB", "CD45"),
...
saveRDS(
  dists,
  file.path("./tests/testthat/testdata/testdata_Euclidean_dist.rds")
)
...
adj <- create_bigraph_manual(
  cell_dists = ca_dists[["cc"]],
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_outgoing_noLoops_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_all_noLoops_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_incoming_noLoops_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_outgoing_noLoops_trans_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_all_noLoops_trans_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_incoming_noLoops_trans_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_outgoing_withLoops_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_all_withLoops_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_incoming_withLoops_gcKNN.rds"
)
...
adj <- readRDS(
  "./tests/testthat/testdata/testdata_trans_gcKNN_withLoops_adj.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_outgoing_withLoops_trans_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_all_withLoops_trans_gcKNN.rds"
)
...
saveRDS(
  snn_igraph,
  "./tests/testthat/testdata/SNN_igraph_incoming_withLoops_trans_gcKNN.rds"
)
