...
#'
#' @export
setGeneric("annotate_by_goa", function(obj, goa_res, alpha = 0.05) {
...
setMethod(
  ...
  function(obj, goa_res, alpha = 0.05) {
    ...
    names(gcs) <- rownames(obj@inc)[obj@gene_idxs]
    names(ccs) <- rownames(obj@inc)[obj@cell_idxs]
...
setMethod(
  ...
  function(
    ...
    cabic <- annotate_by_goa(obj = obj, goa_res = goa_res, alpha = alpha)
...
setMethod(
  ...
  function(
    ...
    caclust <- annotate_by_goa(obj = caclust, goa_res = goa_res, alpha = alpha)
